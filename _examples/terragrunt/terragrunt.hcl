##------------------------------------------------
## Terragrunt configuration for DigitalOcean CDN
##
## Prerequisites:
...
##------------------------------------------------
terraform {
  source = "git::https://github.com/terraform-do-modules/terraform-digitalocean-cdn.git//?ref=v1.0.0"
...
##------------------------------------------------
## Module inputs
## origin: set to the bucket domain name of an existing Spaces bucket
## e.g. "my-bucket.nyc3.digitaloceanspaces.com"
##
## For a custom domain with TLS, also set:
##   custom_domain    = "assets.example.com"
##   certificate_name = "<name-of-do-managed-cert>"
##------------------------------------------------
inputs = {
  enabled = true
  origin  = "${local.project}-assets.${local.region}.digitaloceanspaces.com"
  ttl     = 3600
}
